...
print("Read\tExpectedInsertSize\tLocation\tAnnotation\tInsertionSequence")
                    ...
                    if asm_start - read_to_contig_start >= 500 and read_to_contig_end - asm_end >= 500:
                        ...
                        if check_no_indels(row[22]):
                            ...
                            try:
                                ...
                                if read_start == 0:
                                    continue
                                print(row[0]+'\t'+str(asm_end - asm_start)+'\t'+passing_inserts[row[5]][pos]+'\t'+insert_annoations[row[5]][pos]+"\t"+seq[read_start:read_end+1])
                            except KeyError:
